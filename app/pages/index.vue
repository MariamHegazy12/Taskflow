...
import { Trash2, Calendar, AlertTriangle, Search, Inbox, Sparkles, Clock, CheckCircle2, Filter } from '@lucide/vue'
        ...
        >
          <div>
            ...
            <div class="flex items-start justify-between gap-3">
              <h3 class="text-base font-bold text-app-text group-hover:text-indigo-500 transition-colors">
                {{ task.title }}
              </h3>
              <span
